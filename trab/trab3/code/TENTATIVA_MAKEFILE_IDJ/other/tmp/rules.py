...
tokens = ["ERRU", "CHAR_TYPE", "INT_TYPE", "FLOAT_TYPE",
  "MAT_TYPE", "VOID", "CHAR", "INT",
  "FLOAT", "LETTER_", "DIGIT", "ID",
  "FN", "AHEAD", "LP", "RP", "LS", "RS",
  "LC", "RC", "EQ", "LT", "GT", "LE", "GE",
  "NEQ", "ADD", "SUB", "MUL", "DIV", "MAT_MUL",
  "MAT_POW", "AND", "OR", "NOT", "ADDR", "IF",
  "ELSE", "WHILE", "RETURN", "COPY", "PRINT", "READ",
  "ASCII", "SEMI_COLON","DOT", "COMMA", "ATTR", "XOR_BITWISE",
...
rules = ["program : global-stmt-list",
