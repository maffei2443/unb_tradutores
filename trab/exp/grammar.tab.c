...
#line 136 "grammar.tab.c" /* yacc.c:355  */
};
...
#line 43 "grammar.y" /* yacc.c:1646  */
    {
  (yyval.no) = No_New((yyvsp[-2].no)->v + (yyvsp[0].no)->v);
  add_Node_Child((yyval.no), (yyvsp[-2].no));
  add_Node_Child((yyval.no), (yyvsp[0].no));
}
