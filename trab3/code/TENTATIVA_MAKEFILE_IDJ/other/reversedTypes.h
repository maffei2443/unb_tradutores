...
typedef struct {
  union {
    struct {BaseType* baseType; Id* id;  void* paramListVoid; void* block;} op0;
  }u;
  int tag;
} DefFun;
typedef struct {
  union {
    struct {BaseType* baseType; Id* id;  void* paramListVoid; ;} op0;
  }u;
  int tag;
} DeclFun;
typedef struct {
...
typedef struct {
  union {
    struct {Id* id;  void* expr; ;} op0;
  }u;
  int tag;
} SimpleAttr;
typedef struct {
  union {
    struct {Id* id;  NumId* numId;   void* expr; ;} op0;
  }u;
  int tag;
} IndexAttr;
typedef struct {
  union {
    struct {Id* id;   void* numListList; } op0;
    struct {Id* id;  NumId* numId;   ; void* numList; } op1;
    struct {Id* id;  NumId* numId0; NumId* numId1;   void* expr;} op2;
  }u;
  int tag;
} MatAttr;
typedef struct {
